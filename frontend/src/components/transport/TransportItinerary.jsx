...
import { Train, Bus, Plane, Footprints, Car, Bike, Clock, AlertTriangle, Users, ChevronDown, ChevronUp, Sparkles } from 'lucide-react';
                            ...
                            <div className="ml-6 pb-5">
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2">
                                            {leg.isLive && (
                                                <div className="flex items-center gap-1 px-1.5 py-0.5 rounded-md bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20">
